...
class C_DatetimeValid extends AnyFunSuite {
  ...
  test("timezone") {
    val Right(result) = arktekk.oppgave3.toml.parseAll("""utc  = 1987-07-05T17:45:56Z
  ...
  test("datetime") {
    val Right(result) = arktekk.oppgave3.toml.parseAll("""space = 1987-07-05 17:45:00Z
      |
  ...
  test("local") {
    val Right(result) = arktekk.oppgave3.toml.parseAll("""local = 1987-07-05T17:45:00
  ...
  test("no-seconds") {
    val Right(result) = arktekk.oppgave3.toml.parseAll("""# Seconds are optional in date-time and time.
  ...
  test("leap-year") {
    val Right(result) = arktekk.oppgave3.toml.parseAll("""2000-datetime       = 2000-02-29 15:15:15Z
  ...
  test("edge") {
    val Right(result) = arktekk.oppgave3.toml.parseAll("""first-offset = 0001-01-01 00:00:00Z
  ...
  test("milliseconds") {
    val Right(result) = arktekk.oppgave3.toml.parseAll("""utc1  = 1987-07-05T17:45:56.123Z
  ...
  test("local-time") {
    val Right(result) = arktekk.oppgave3.toml.parseAll("""besttimeever = 17:45:00
